...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/consulta2.js?<?php echo time();?>"></script>
		...
		<div class="divForm">
			...
			<div class="row">
				<div class="col-md-10">
					  ...
					  <div class="form-group">
					    <label for="nombre" class="col-sm-4 control-label">Por Oficio</label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" name="DESCRIP_OFICIO" id="DESCRIP_OFICIO" placeholder="">
					    </div>
					  </div>
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
					    <label for="anio" class="col-sm-4 control-label">Plurianual</label>
					    <div class="col-sm-8">
