...
*/
$config['tables']['users']           = 'T_USUARIOS';
$config['tables']['groups']          = 'T_GRUPOS';
$config['tables']['users_groups']    = 'T_USUARIO_GRUPOS';
$config['tables']['login_attempts']  = 'T_LOGIN_ATTEMPTS';
...
$config['default_group']              = 'visualizador';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'NOMBRE_USUARIO';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
